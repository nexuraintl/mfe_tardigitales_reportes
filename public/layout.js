"use strict";var NxAdminLayoutBundle=(()=>{var F=Object.defineProperty;var yt=Object.getOwnPropertyDescriptor;var jt=Object.getOwnPropertyNames;var Xt=Object.prototype.hasOwnProperty;var Ht=(i,e)=>{for(var t in e)F(i,t,{get:e[t],enumerable:!0})},Vt=(i,e,t,o)=>{if(e&&typeof e=="object"||typeof e=="function")for(let a of jt(e))!Xt.call(i,a)&&a!==t&&F(i,a,{get:()=>e[a],enumerable:!(o=yt(e,a))||o.enumerable});return i};var Ft=i=>Vt(F({},"__esModule",{value:!0}),i),g=(i,e,t,o)=>{for(var a=o>1?void 0:o?yt(e,t):e,n=i.length-1,r;n>=0;n--)(r=i[n])&&(a=(o?r(e,t,a):r(a))||a);return o&&a&&F(e,t,a),a};var le={};Ht(le,{NxAdminFooter:()=>D,NxAdminHeader:()=>S,NxAdminLayout:()=>M,NxAdminModContent:()=>U,NxAdminModOptions:()=>z,NxAdminModSidebar:()=>T,adminLayoutStyles:()=>vt,baseLayoutStyles:()=>w,commonStyles:()=>gt,contentStyles:()=>tt,footerStyles:()=>et,headerStyles:()=>Q,optionsStyles:()=>J,sidebarStyles:()=>Z});var wt=`/**\r
...
`;var v=i=>(e,t)=>{t!==void 0?t.addInitializer(()=>{customElements.define(i,e)}):customElements.define(i,e)};var S=class extends b{constructor(){super(...arguments);this.appTitle="Nexura Platform";this.logoPlatform="assets/images/logo-app-solution.svg";this.logoEntity="assets/images/logo-jcc.png";this.searchPlaceholder="Buscar en la plataforma...";this.searchQuery="";this.openDropdown=null;this.currentUser={name:"Fabian Vargas",email:"fvargas@nexura.com",role:"Administrador",initials:"FV"};this.appGrid=[{id:"tarjetas",name:"Tarjetas",color:"blue",iconClass:"fa fa-id-card",iconText:"\u25A3",path:"/tarjetas-contadores",active:!0},{id:"sociedades",name:"Sociedades",color:"cyan",iconClass:"fa fa-building-o",iconText:"\u25A3",path:"/sociedades"},{id:"notificaciones",name:"Notificaciones",color:"orange",iconClass:"fa fa-bell-o",iconText:"\u25CF",path:"/crear-notificacion"},{id:"tramites",name:"Tr\xE1mites",color:"green",iconClass:"fa fa-file-text-o",iconText:"\u25A4",path:"/crud"},{id:"reportes",name:"Reportes",color:"purple",iconClass:"fa fa-bar-chart",iconText:"\u25A5",path:"/reportes"},{id:"validador",name:"Validador QR",color:"dark",iconClass:"fa fa-qrcode",iconText:"\u25A6",path:"/validador-qr"}];this.settingsOptions=[{id:"general",label:"Configuraci\xF3n general",icon:"\u2699"},{id:"help",label:"Ayuda y soporte",icon:"?"}];this._boundWindowClick=t=>{if(!this.openDropdown)return;t.composedPath().some(n=>n instanceof HTMLElement&&(n.classList?.contains("nx-dropdown")||n.classList?.contains("nx-dropdown-host")))||(this.openDropdown=null,this.requestUpdate())}}connectedCallback(){if(super.connectedCallback(),window.addEventListener("click",this._boundWindowClick),typeof document<"u"&&!document.querySelector('link[href*="font-awesome"]')){let t=document.createElement("link");t.rel="stylesheet",t.href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css",document.head.appendChild(t)}}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("click",this._boundWindowClick)}_toggleSidebar(t){t&&(t.preventDefault(),t.stopPropagation()),this.dispatchEvent(new CustomEvent("nx-toggle-sidebar",{bubbles:!0,composed:!0})),typeof window<"u"&&window.dispatchEvent(new CustomEvent("nx-toggle-sidebar",{bubbles:!0,composed:!0}))}_toggleDropdown(t,o){o.stopPropagation(),this.openDropdown=this.openDropdown===t?null:t}_renderIcon(t){return t?t.startsWith("fa ")||t.startsWith("fa-")?s`<i class="${t}"></i>`:s`<span>${t}</span>`:s`<i class="fa fa-circle-o"></i>`}_getUserInitials(){if(this.currentUser?.initials)return this.currentUser.initials;if(this.currentUser?.name){let t=this.currentUser.name.trim().split(/\s+/);return t.length>=2?(t[0][0]+t[1][0]).toUpperCase():t[0].substring(0,2).toUpperCase()}return"NX"}_onAppSelect(t,o){o.preventDefault(),this.openDropdown=null,this.dispatchEvent(new CustomEvent("nx-app-change",{detail:t,bubbles:!0,composed:!0})),t.path&&this.dispatchEvent(new CustomEvent("nx-navigate",{detail:{path:t.path},bubbles:!0,composed:!0}))}_onProfileSelect(t){this.openDropdown=null,this.dispatchEvent(new CustomEvent("nx-profile-action",{detail:{actionId:t},bubbles:!0,composed:!0}))}render(){let t=this._getUserInitials();return s`
                    ...
                    <div class="nx-submenu">
                      ${n.children.map(f=>{let x=this._isPathActive(f.path);return s`
                          <button 
                            ...
                            aria-label="${f.label}"
                            @click="${at=>this._onItemClick(f,at)}">
                            ${f.icon?s`
    ...
    `}};z.styles=[w,J],z.properties={pageTitle:{type:String,attribute:"page-title"},showBackButton:{type:Boolean,attribute:"show-back-button"},actions:{type:Array},openMenu:{state:!0}},z=g([v("nx-admin-mod-options")],z);var U=class extends b{render(){return s`
    ...
    `],U=g([v("nx-admin-mod-content")],U);var D=class extends b{constructor(){super(...arguments);this.copyrightText=`\xA9 ${new Date().getFullYear()} Nexura Platform. Todos los derechos reservados.`}render(){return s`
              ...
              ${o.map((n,r)=>s`
                ...
                ${n.items.map((l,p)=>{let c=!!(l.children&&l.children.length>0),h=l.id||`group-${r}-${p}-${l.label}`,d=c&&this._isGroupOpen(l,h),m=c&&this._hasActiveChild(l),f=!c&&this._isPathActive(l.path);return c?s`
                      <div class="nx-nav-group ${d?"open":""}">
                        ...
                        <div class="nx-submenu">
                          ${l.children.map(x=>{let at=this._isPathActive(x.path);return s`
                              <button 
                                type="button"
                                class="nx-sub-item ${at?"active":""}"
                                aria-label="${x.label}"
                                @click="${Rt=>this._onItemClick(x,Rt)}">
                                ${x.icon?s`
    ...
    `}};M.styles=vt,M.properties={appTitle:{type:String,attribute:"app-title"},activePath:{type:String,attribute:"active-path"},logoPlatform:{type:String,attribute:"logo-platform"},logoEntity:{type:String,attribute:"logo-entity"},version:{type:String},menuSections:{type:Array},menuItems:{type:Array},currentUser:{type:Object},appGrid:{type:Array},settingsOptions:{type:Array},primaryAction:{type:Object,attribute:"primary-action"},sidebarCollapsed:{state:!0},sidebarOpenMobile:{state:!0},openDropdown:{state:!0},openGroups:{state:!0},closedGroups:{state:!0}},M=g([v("nx-admin-layout")],M);if(typeof document<"u"&&!document.getElementById("nx-admin-layout-global-theme")){let i=document.createElement("style");i.id="nx-admin-layout-global-theme",i.textContent=wt,document.head.appendChild(i)}return Ft(le);})();
